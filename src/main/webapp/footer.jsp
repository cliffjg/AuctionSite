            ...
            <div class="row justify-content-center">
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                    ...
                    <ul class="list-unstyled">
                        <li><a class="link-light" href="#">Auctions</a></li>
                        <li><a class="link-light" href="#">Vehicle Reports</a></li>
                        <li><a class="link-light" href="#">Towing</a></li>
                    </ul>
                </div>
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a class="link-light" href="#">Our History</a></li>
                    </ul>
                </div>
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                ...
                <div class="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social">
                    <div class="fw-bold d-flex align-items-center mb-2">
                    	<span class="d-flex justify-content-center align-items-center bs-icon me-2">
                    		<img style="width: 30px;height: 30px;background: rgb(34,37,41);border-width: 1px;border-color: rgb(34,37,41);" src="assets/img/auction.png">
                    	</span>
                    	<span>AuctionUp</span>
                    </div>
